...
Authors : Tomas O'Malley and Dylan Creaven . Fourth year Software  Development @ Galway Mayo institute  of Technology .
...
This presentation is a for the module Research Methods in IT    . We both agreed to base our project  on the first female winner of the Turing Award Frances Allen. who recently passed away this year. 
...
\section{ Scope  }
\subsection{Presenatation Scope }
...
\section{ Allen Turing Award   }
\subsection{Who is Allen Turing  ?}
\subsection{What is the  Allen Turing  ?}
...
\section{ Allen Franches    }
\subsection{History   }
\subsection{Accomplishments in Computing   }
\subsection{Other contirubutions to computing   }
